    ...
    async getWatchlistData() {
        ...
        try {
            ...
            const response = await axios({
                method: 'GET',
                url: URL,
                headers: { authorization: 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..fdVpZRutdN1L2STk_guAOHMzvf6G_lnaHl1FXHMWkoA' }
            });
            if (response.data &&
